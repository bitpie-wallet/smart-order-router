...
export declare const EGGS_MAINNET: Token;
...
export declare const USDT_BASE_TRON: Token;
...
export declare class TokenProvider implements ITokenProvider {
    ...
    private getTokensWithMulticall;
    private getTokensWithIndividualCalls;
    private makeIndividualCall;
}
