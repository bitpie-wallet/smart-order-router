...
export declare const routeHasNativeTokenInputOrOutput: (routeWithValidQuote: RouteWithValidQuote) => boolean;
export declare const routeHasWrappedNativeTokenInputOrOutput: (routeWithValidQuote: RouteWithValidQuote) => boolean;
