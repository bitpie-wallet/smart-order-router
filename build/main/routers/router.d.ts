...
import { CondensedAddLiquidityOptions, MixedRouteSDK, Protocol, TPool, Trade } from '@uniswap/router-sdk';
...
import { Pool, Position, MethodParameters as SDKMethodParameters, Pool as V3Pool, Route as V3RouteRaw } from '@uniswap/v3-sdk';
...
export declare function cloneV2RouteWithNewPools(originalRoute: V2Route, newPools: Pair[]): V2Route;
export declare function cloneV3RouteWithNewPools(originalRoute: V3Route, newPools: V3Pool[]): V3Route;
export declare function cloneV4RouteWithNewPools(originalRoute: V4Route, newPools: V4Pool[]): V4Route;
export declare function cloneMixedRouteWithNewPools(originalRoute: MixedRoute, newPools: TPool[]): MixedRoute;
