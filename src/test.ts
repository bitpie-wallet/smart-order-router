...
async function main() {
  ...
  // // 测试 ChainId 扩展功能
  // await testChainIdExtension();

  // // 测试 OnChainQuoteProvider TRON 特殊逻辑
  // await testOnChainQuoteProvider();

  // // 测试 TokenProvider 单个请求功能
  // await testTokenProvider();

  // // 测试 V3PoolProvider 单个请求功能
  // await testV3PoolProvider();
